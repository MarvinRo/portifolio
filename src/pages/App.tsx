...
function App() {
  ...
  return (
    <>
      ...
      <section id="apresentacao" className=" flex flex-col items-center justify-center w-full p-0 border-0 bg-gradient-to-b from-[#061420] to-[#001423] ">
        ...
        <div className="z-10 -mt-6 h-[330px] text-[24px] mx-[10%] text-white ">
          ...
          <Carousel className='w-[800px]' >
            <CarouselContent>
              <CarouselItem>
                ...
                <h1 className="">AADC(Agência Amazonence de Desenvolvimeento Cultural)</h1>
                <ul className=' '>
                  <li>asdfdsafdsafdsafdsa</li>
                  <li>fdsafdsafdsafdsafdsafdsaf</li>
                  <li>fdsafdsafdsafdsafdsafdsafa</li>
                </ul>
              </CarouselItem>
